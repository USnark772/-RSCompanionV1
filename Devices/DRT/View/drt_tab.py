...
from Devices.DRT.Model.defs import drtv1_0_ISI_min, drtv1_0_stim_dur_min, drtv1_0_max_val
from Model.defs import tab_line_edit_compliant_style, tab_line_edit_error_style
