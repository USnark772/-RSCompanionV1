...
from graph_obj import GraphObj
from vog_tab import VOGTab
from vog_defs import vog_max_open_close, vog_min_open_close, vog_debounce_max, vog_debounce_min, \
...
class VOGController:
    ...
    def add_data_to_graph(self, timestamp, data):
        print("timestamp:", timestamp, "type:", type(timestamp), "data:", data, "type:", type(data))
