...
#define OutputName "companion_app_v1_09_1"
#define FilePath "C:\RSDev\Builds\Version 1\Build 1.09\build\exe.win32-3.7\"
...
AppId={{BA5CEBB-C556-4AEF-83DF-7D518691E1C4}
AppName={#MyAppName}
...
[Files]
Source: {#FilePathExe}; DestDir: "{app}"; Flags: ignoreversion
Source: {#FilePathStar}; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Run]
Filename: "{app}\redist\vc_redist.x86.exe"; Parameters: "/q /norestart /q:a /c:""VCREDI~3.EXE /q:a /c:""""msiexec /i vcredist.msi /qn"""" """; Check: VCRedistNeedsInstall; WorkingDir: {app}\redist; StatusMsg: Installing VC++ 2015-2019 Redistributables...
...
begin
  Result := not (VCVersionInstalled(VC_2015_2019_REDIST_X86_ADD));
end;
